...
namespace BNG
{
    ...
    public class Grabber : MonoBehaviour
    {
        ...
        /// <summary>
        /// Public method to grab a specified Grabbable on request.
        /// </summary>
        public virtual void GrabObjectOnCommand(Grabbable item)
        {
            if (item == null)
            {
                Debug.LogWarning("GrabObjectOnCommand received a null item. Aborting.");
                return;
            }
